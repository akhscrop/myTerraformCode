...
inputs = {
  ...
  custom_policy_name = "vod_service_service_account_role_policy"
  role_policy_arns = []
  custom_policy = <<EOF
{
  "Version": "2012-10-17",
...
EOF
  ...
  role_name = "vod_service_service_account_role"
 
  create_role = true
  oidc_id = dependency.eks.outputs.eks_oidc_id
  service_account_namespace = "vod"
  service_account_name = "vod-service-sa"
